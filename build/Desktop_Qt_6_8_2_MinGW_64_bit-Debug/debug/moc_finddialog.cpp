...
void FindDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (FindDialog::*)(int , const QString & );
            if (_q_method_type _q_method = &FindDialog::findSignal; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (FindDialog::*)();
            if (_q_method_type _q_method = &FindDialog::findclosed; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void FindDialog::findSignal(int _t1, const QString & _t2)
{
